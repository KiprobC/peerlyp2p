-- Drop ALL existing overloaded versions of create_sell_offer_with_reservation
DROP FUNCTION IF EXISTS public.create_sell_offer_with_reservation(uuid, text, numeric, text, numeric, numeric, numeric, numeric, text[], text, integer);
DROP FUNCTION IF EXISTS public.create_sell_offer_with_reservation(uuid, text, numeric, numeric, numeric, numeric, numeric, text[], integer, text, text);

-- Create single canonical function with consistent parameter order matching frontend usage
