...
interface PaymentWindowTimerProps {
  expiresAt: string | null;
  tradeStatus: string;
  onExpired?: () => void;
}

export const PaymentWindowTimer = ({ expiresAt, tradeStatus, onExpired }: PaymentWindowTimerProps) => {
  ...
  useEffect(() => {
    ...
    // Only show timer for pending/confirmed trades (before payment sent)
    // This timer STOPS once payment is marked as sent
  ...
  // Don't show timer if trade status moved past payment window
